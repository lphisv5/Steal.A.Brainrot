...
local Window = Fluent:CreateWindow({
    Title = game:GetService("MarketplaceService"):GetProductInfo(109983668079237).Name .. " 〢 YANZ",
...
-- เพิ่มข้อมูลเกี่ยวกับ Fluent ในแท็บ Updates
Tabs.Updates:AddParagraph({
    Title = "About Fluent UI Library",
    Content = "Fluent is an open-source UI library for Roblox, designed to create modern and customizable interfaces. It offers components like buttons, sliders, dropdowns, and more. Check out the GitHub for examples and source code: https://github.com/dawid-scripts/Fluent"
})
...
Tabs.Main:AddButton({
    ...
    Callback = function()
        ...
        if cloak and cloak:GetAttribute("SpeedModifier") == 2 then
            ...
            Fluent:Notify({ Title = "YANZ", Content = "Use Invisibility Cloak First", Duration = 2 })
        end
    end
})
...
Tabs.Updates:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({ Title = "YANZ", Content = "Copied Successfully", Duration = 2 })
    end
})
